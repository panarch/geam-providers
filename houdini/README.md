...
The Geam and Geam Core dependencies use the same pinned main commit, cf5fb100c9220d9e30ff60a11d5bfbeb77f1ebef. The [standalone fixture](fixtures/gleam/) selects this provider explicitly; the [embedding fixture](fixtures/embedding/) consumes this crate directly. Both use the original package from Hex.
