...
The Geam and Geam Core dependencies use the same pinned main commit, b23d82a23d31c77eca749d18f67e73f0d9d952c7. The [standalone fixture](fixtures/gleam/) selects this provider explicitly; the [embedding fixture](fixtures/embedding/) consumes this crate directly. Both use the original package from Hex.
