...
The Geam dependency is pinned to `main` commit `76c4ab7c6a2c0c35975bdd97e5de7c6284f895e7`. See the [testing guide](../docs/development/testing.md) for the current verification commands. Publishing the crate and testing registry-based consumption are separate steps while Geam remains Git-pinned.
