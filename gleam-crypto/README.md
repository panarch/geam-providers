...
The Geam dependency is pinned to `main` commit `bd95b872c578df88f76ed5c4175fb1ea55ee8607`. See the [testing guide](../docs/development/testing.md) for the current verification commands. Publishing the crate and testing registry-based consumption are separate steps while Geam remains Git-pinned.
