...
The Geam dependency is pinned to `main` commit `cf5fb100c9220d9e30ff60a11d5bfbeb77f1ebef`. See the [testing guide](../docs/development/testing.md) for the current verification commands. Publishing the crate and testing registry-based consumption are separate steps while Geam remains Git-pinned.
